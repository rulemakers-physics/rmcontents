...
// [수정] Inter 폰트 import 제거
// import { Inter } from "next/font/google";
import "./globals.css"; // Next.js 기본 CSS (Pretendard 폰트 설정 포함)
...
export default function RootLayout({
  ...
  return (
    <html lang="ko">
      {/* [수정] inter.className 제거 (body 태그가 globals.css의 폰트를 상속받음) */}
      <body className="flex min-h-screen flex-col">
        <AuthProvider>
          {" "}
          {/* 모든 페이지에서 로그인 상태를 알 수 있게 함 */}
