...
export const metadata: Metadata = {
  ...
  metadataBase: new URL('https://pass.rulemakers.co.kr'), 
  alternates: {
  ...
  title: {
    ...
    default: 'PASS 문제은행 by RuleMakers - 통합과학 문제은행 & 학원 관리 솔루션',
  },
  
  description: '서울대 사범대 출신 연구진이 모인 룰메이커스에서 제작한 프리미엄 통합과학 문제은행과 맞춤형 컨텐츠 제작 서비스',
  
  keywords: [
    '문제은행', '통합과학 문제은행', '룰메이커스 컨텐츠', '통합과학 내신 컨텐츠', '통합과학 자료', '과학 컨텐츠', '과학문제은행', '통합과학', '물리학', '화학', '생명과학', '지구과학', '통과', '물리', '생명', '지구', '과학 내신', '통과 내신', '통합과학 내신', '물리 내신', '화학 내신', '생명 내신', '지구 내신',
