// components/HighLevelPdfViewer.tsx
"use client";
...
export default function HighLevelPdfViewer() {
  ...
  return (
    <div className="flex flex-col items-center w-full max-w-5xl mx-auto">
      ...
      >
        {/* [핵심] 고난이도 전용 PDF 파일 경로 설정 */}
        {/* public 폴더에 sample_high_level.pdf 파일을 넣어주세요 */}
        <Document
          file="/sample_high_level.pdf" 
          onLoadSuccess={onDocumentLoadSuccess}
          loading={
            <div className="h-full w-full flex items-center justify-center text-slate-500">
              <div className="flex flex-col items-center gap-3">
                <div className="w-10 h-10 border-4 border-indigo-200 border-t-indigo-600 rounded-full animate-spin" />
                <span className="font-medium">킬러 문항 샘플 로딩 중...</span>
              </div>
            </div>
          }
          error={
            <div className="h-full w-full flex flex-col items-center justify-center text-red-400 gap-2">
              ...
              <p className="text-sm text-slate-500">public 폴더에 sample_high_level.pdf 파일이 있는지 확인해주세요.</p>
            </div>
          }
        ...
        >
          {Array.from(new Array(numPages), (el, index) => (
            ...
            >
              ...
              {/* [수정] 워터마크 텍스트 변경: High-End Killer */}
